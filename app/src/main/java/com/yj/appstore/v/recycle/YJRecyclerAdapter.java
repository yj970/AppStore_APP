...
public abstract class YJRecyclerAdapter<T> extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ((YJViewHolder) holder).showEmpty(isShowEmpty, type, tipString);
        }
        if (!isShowEmpty) {
            onBindHolder(((YJViewHolder) holder).getView(), position);
            holder.itemView.setTag(position);
        }
    ...
    public static class YJViewHolder extends RecyclerView.ViewHolder {
        protected LinearLayout parent;

        public static YJViewHolder newInstance(View view) {
            // 搞事情
            ...
            return new YJViewHolder(parent);
        }

        public YJViewHolder(View itemView) {
            super(itemView);
    ...
    public abstract YJViewHolder onCreateHolder(ViewGroup parent, int viewType);
